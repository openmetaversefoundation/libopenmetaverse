...
namespace OpenMetaverse
{
    ...
    public static class VisualParams
    {
        ...
        static VisualParams()
        {
            ...
            Params[1003] = new VisualParam(1003, "Eyebrow Density", 1, null, String.Empty, String.Empty, String.Empty, 0f, 0f, 1f, false, null, null, new VisualColorParam(VisualColorOperation.Blend, new Color4[] { new Color4(255, 255, 255, 0), new Color4(255, 255, 255, 255) }));
