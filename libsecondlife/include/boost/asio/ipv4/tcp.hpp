...
#ifndef BOOST_ASIO_IPV4_TCP_HPP
#define BOOST_ASIO_IPV4_TCP_HPP
...
/**
 * The boost::asio::ipv4::tcp class contains flags necessary for TCP sockets.
 *
 * @par Thread Safety:
...
public:
   ...
   * boost::asio::stream_socket socket(demuxer); 
   * ...
   * boost::asio::ipv4::tcp::no_delay option;
...
/**
 * The boost::asio::ipv4::tcp::endpoint class describes an endpoint that may be
