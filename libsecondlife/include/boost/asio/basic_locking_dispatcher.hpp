...
#ifndef BOOST_ASIO_BASIC_LOCKING_DISPATCHER_HPP
#define BOOST_ASIO_BASIC_LOCKING_DISPATCHER_HPP
 ...
 *
 * Most applications will use the boost::asio::locking_dispatcher typedef.
 *
 * @par Thread Safety:
...
#endif // BOOST_ASIO_BASIC_LOCKING_DISPATCHER_HPP
