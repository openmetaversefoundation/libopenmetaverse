 ...
 *
 * Most applications will use the boost::asio::datagram_socket typedef.
 *
 * @par Thread Safety:
...
public:
   ...
   * socket.open(boost::asio::ipv4::udp());
   * @endcode
   */
   ...
   * socket.open(boost::asio::ipv4::udp(), boost::asio::assign_error(error));
   * if (error)
   * {
   *   // An error occurred.
   * }
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * socket.open(boost::asio::ipv4::udp());
   * socket.bind(boost::asio::ipv4::udp::endpoint(12345));
   * @endcode
   */
  template <typename Endpoint>
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * ...
   * boost::asio::ipv4::udp::endpoint endpoint(12345, "1.2.3.4");
   ...
   * boost::asio::ipv4::multicast::enable_loopback
   *
   * @par Example:
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * ...
   * boost::asio::datagram_socket::do_not_route option(true);
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * ...
   * boost::asio::datagram_socket::bytes_readable command;
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * ...
   * boost::asio::ipv4::udp::endpoint endpoint;
   ...
   * boost::asio::datagram_socket socket(demuxer);
   * ...
   * socket.shutdown(boost::asio::datagram_socket::shutdown_send);
   * @endcode
   */
   ...
   * @code socket.send(boost::asio::buffer(data, size), 0); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * boost::asio::ipv4::udp::endpoint destination(12345, "1.2.3.4");
   * socket.send_to(boost::asio::buffer(data, size), 0, destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   *     boost::asio::buffer(data, size), 0, destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(boost::asio::buffer(data, size), 0); @endcode
   ...
   * follows:
   * @code
   * boost::asio::ipv4::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     boost::asio::buffer(data, size), 0, sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
