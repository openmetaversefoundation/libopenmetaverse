...
if(.%1)==(.) echo C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\msbuild OpenMetaverse.sln >> compile.bat

if(.%1)==(.msbuild) echo C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\msbuild /p:Configuration=Release OpenMetaverse.sln >> compile.bat
...
if(.%2)==(.runtests) echo "c:\Program Files\NUnit 2.4.7\bin\nunit-console.exe" /nologo /nodots bin\OpenMetaverse.Tests.dll >> compile.bat
