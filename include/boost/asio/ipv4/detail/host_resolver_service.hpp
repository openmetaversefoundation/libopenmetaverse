...
#ifndef BOOST_ASIO_IPV4_DETAIL_HOST_RESOLVER_SERVICE_HPP
...
private:
  ...
  public:
    ...
    {
      if (h_)
        boost::asio::detail::socket_ops::freehostent(h_);
    }
...
public:
  ...
  void get_local_host(impl_type& impl, host& h, Error_Handler error_handler)
  {
    ...
    {
      error_handler(boost::asio::error(
            boost::asio::detail::socket_ops::get_error()));
    }
    else
    {
      ...
      Error_Handler error_handler)
  {
    ...
    int error = 0;
    in_addr a;
    a.s_addr = boost::asio::detail::socket_ops::host_to_network_long(
        addr.to_ulong());
    auto_hostent result(boost::asio::detail::socket_ops::gethostbyaddr(
    ...
    if (result == 0)
      ...
      error_handler(boost::asio::error(boost::asio::error::host_not_found));
    else
  ...
  public:
    ...
    void operator()()
    {
      ...
      if (impl_.expired())
      {
        demuxer_.post(boost::asio::detail::bind_handler(handler_,
      ...
      auto_hostent result(boost::asio::detail::socket_ops::gethostbyaddr(
            reinterpret_cast<const char*>(&a), sizeof(in_addr), AF_INET, &ent,
            buf, sizeof(buf), &error));
      boost::asio::error e(boost::asio::error::success);
      if (result == 0)
        e = boost::asio::error(error);
      else if (ent.h_length != sizeof(in_addr))
        e = boost::asio::error(boost::asio::error::host_not_found);
      else
        populate_host_object(host_, ent);
      demuxer_.post(boost::asio::detail::bind_handler(handler_, e));
    }
      ...
      Error_Handler error_handler)
  {
    ...
    char buf[8192] = ""; // Size recommended by Stevens, UNPv1.
    int error = 0;
    auto_hostent result(boost::asio::detail::socket_ops::gethostbyname(
  ...
  static void populate_host_object(host& h, hostent& ent)
  {
    ...
    for (char** addr = ent.h_addr_list; *addr; ++addr)
    {
      ...
      addresses.push_back(address(
            boost::asio::detail::socket_ops::network_to_host_long(a.s_addr)));
    }
...
private:
  ...
  void start_work_thread()
  {
    ...
    if (work_thread_ == 0)
    {
      work_thread_ = new boost::asio::detail::thread(
  ...
  boost::asio::detail::thread* work_thread_;
};
...
#endif // BOOST_ASIO_IPV4_DETAIL_HOST_RESOLVER_SERVICE_HPP
